...
public class ReceiveParameterServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	    System.out.println("doGet ReceiveParameterServlet");
	    // forward 接法
	    String forwardString = (String)req.getAttribute("name");
	    System.out.println("Forward-String: " + forwardString);
	    
	    // Redirect 接法
	    // 使用Session範圍物件
        HttpSession session = req.getSession();
        System.out.println("Redirect-session: " + session.getAttribute("name"));
	}
